...
export const detectVoNamespace = (nodeMeta: {ns?: string, namespace?: string, voNamespace?: string}, node: Node): string | CodyResponse => {
    return nodeMeta.ns || nodeMeta.namespace || nodeMeta.voNamespace || '/';
}
